<template>
  <div>
    ...
    <div v-if="this.active==0">
      <el-button  @click="dialogAllKGVisible = true;loadCandidateData(candidateKgCurrentPage,candidateKgPageSize)" class="operation_button" type="primary">选择本体</el-button>
    ...
    <div v-if="this.active==1">
      ...
      <el-card shadow="never" v-loading="simLoading" element-loading-text="正在计算相似度,请稍后...">
        <el-table
          ...
          <el-table-column
              label="类别(目标本体)" :show-overflow-tooltip="true">
            <template slot-scope="scope">
              <div>{{ scope.row.to }}
                <el-image
          ...
          <el-table-column
              label="类别(候选本体)" :show-overflow-tooltip="true">
            <template slot-scope="scope">
              <div>{{ scope.row.from}}
                <el-image
                    style="display:none;top:3px;width: 20px;height:20px"
