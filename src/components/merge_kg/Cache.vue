    ...
    <el-dialog title="缓存表" :visible.sync="cacheDisplay" width="70%" >
      ...
      <span slot="footer" class="dialog-footer">
        <el-popover
            ...
            <el-button type="danger" class="operation_button" slot="reference" plain icon="el-icon-delete">删除</el-button>
        </el-popover>
        <el-popover
            placement="top"
            ...
            <el-button type="success" slot="reference" class="operation_button" icon="el-icon-upload2" plain>提交</el-button>
        </el-popover>
      </span>
    </el-dialog>
  </div>
